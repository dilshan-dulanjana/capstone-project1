...
import GuideHome from '../../assets/Images/Guidehome.jpg';
...
<Row className="d-flex justify-content-center align-items-center min-vh-50">
    <Col md={6}>
        <Card>
            <Card.Img variant="top" src={GuideHome} />
            <Card.Body>
                ...
                <Link to="/AdminTour"> 
                    <Button variant="primary" style={{ width: "100%", padding: "10px" }}>Upload Your Travel Guide Request</Button>
                </Link>
            </Card.Body>
        </Card>
    </Col>
