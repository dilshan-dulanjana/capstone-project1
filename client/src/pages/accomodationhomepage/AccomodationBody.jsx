...
import Travelhomeimg from "../../assets/abhome.jpg"
        ...
        <div>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <div style={{ display: 'flex', justifyContent: 'center' }}>
                                <Card.Title>Come along and share the accommodation with us!</Card.Title>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'center', fontSize: "18px" }}>
                                <Card.Text>
                                    Join us now and you can earn money. Add your accommodation details
                                </Card.Text>
                            </div>
                            <Button variant="primary" style={{ width: "100%", padding: "10px" }}>Upload Your Accommodation</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
            ...
            <div className="container  bg- ">
                ...
                <div className="flex-container justify-content-center ">
                    <h1 className="txt">Our Top Rated Accommodations</h1>
