  ...
  return (
    <>
      ...
      <div className='tour-guides'>
        <Col>
          <Row>
            <h2 className='agent1'><b>Manage Your Tour Guides</b></h2>
                      ...
                      <Card.Body>
                        {editableTourGuide === tourGuide._id ? (
                          ...
                          <>
                            ...
                            <Button variant='primary' className='mr-2' onClick={() => handleEdit(tourGuide)}>Edit</Button>
                            <Button variant='danger' onClick={() => handleDelete(tourGuide._id)}>Delete</Button>
                          </>
                        )}
                      </Card.Body>
                    </Col>
