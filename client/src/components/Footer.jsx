        ...
        <Row>
          ...
          <Col md={4}>
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="#" className="text-white">Tourism News</a></li>
              <li><a href="#" className="text-white">Video Streaming</a></li>
              <li><a href="#" className="text-white">About Us</a></li>
              <li><a href="#" className="text-white">Tourism Hotline</a></li>
              <li><a href="#" className="text-white">Select Language</a></li>
            </ul>
          </Col>
          <Col md={4}>
            <h5>Follow Us</h5>
